...
def initialize_global_process_group(timeout_second=36000):
    ...
    device = torch.device(get_device_name(), local_rank)
    # Bind each rank to its local GPU before NCCL init. Without device_id,
    # ProcessGroupNCCL guesses from global rank and can hang on multi-node jobs.
