...
class BaseCheckpointManager:
    ...
    def load_checkpoint(self, local_path: str, remote_path: str = None, del_local_after_load: bool = False):
    ...
    @staticmethod
    def checkpath(local_path: str, remote_path: str):
        assert local_path is not None or remote_path is not None, "local_path and remote_path cannot be both None"
        return local_path is not None, local_path if local_path is not None else remote_path
