...
class ActorConfig(BaseConfig):
    ...
    adaptive_kl_loss_reward_key: str = "delta_opd/weighted_reward_mean"
    adaptive_kl_loss_eps: float = 0.02
    adaptive_kl_loss_min_coef: float = 0.5
    adaptive_kl_loss_max_coef: float = 2.5
