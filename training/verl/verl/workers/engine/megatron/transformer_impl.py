...
class MegatronEngine(BaseEngine):
    ...
    def save_checkpoint(
        ...
        **kwargs,
        ...
        Args:
            ...
            remote_path: Optional remote storage path to copy checkpoint.
    ...
    def load_checkpoint(
        self, local_path: str, remote_path: Optional[str] = None, del_local_after_load: bool = True, **kwargs
    ) -> None:
        """
        ...
        Args:
            ...
            remote_path: Optional remote storage path where checkpoint is stored.
